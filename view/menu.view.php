...
<body>
	...
	<div id="input-container">
		<form class="form-inline">
			...
			<button type="button" class="btn btn-primary mb-2 ml-2" onclick="buscarCEP()"> <i class="fas fa-search mr-1"></i> Buscar</button>
		</form>
	</div>
	...
	<script>
		...
		function criarPopup(id, imagemUrl, nome, estrelas, favorito) {
			...
			// Verifica se a variável favorito é verdadeira para desativar o botão de favoritar
			if (favorito) {
				popupContent += '<button class="btn btn-danger btn-sm mr-2" disabled><i class="fas fa-heart"></i></button>';
			} else {
